...
class AppColorsDark {
  ...
  static const Color primaryBgSub = Color(0xFF1E1B4B); // Deep Purple-Indigo base
  ...
  static const Color inkSecondary = Color(0xFFE2E8F0); // Slate 200 (Sub-headline)
  ...
  static const Color canvasSoft   = Color(0xFF131926); // Midnight Slate (Latar belakang scaffold)
  static const Color canvasCream  = Color(0xFF1E2530); // Deep Slate dengan sedikit kehangatan
  ...
  static const Color successBg   = Color(0xFF064E3B); // Emerald 900 (Sangat gelap)
