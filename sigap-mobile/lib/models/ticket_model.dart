...
class TicketModel {
  ...
  factory TicketModel.fromJson(Map<String, dynamic> json) {
    return TicketModel(
      ...
      technicianId: json['technician_id'] != null
          ...
          : null,
      assetId: json['asset_id'] != null ? int.tryParse(json['asset_id'].toString()) : null,
  ...
  static Map<String, dynamic> _getStatusInfo(String status) {
    ...
    // Selesai / Dibatalkan
    if (s == statusSelesai) {
      return {'label': 'Selesai', 'color': 0xFF22C55E, 'bgColor': 0xFFF0FDF4};
    }
    if (s == statusDibatalkan) {
      return {
        'label': 'Dibatalkan',
        'color': 0xFFEF4444,
        'bgColor': 0xFFFEF2F2,
    ...
    // Proses persetujuan
    if (s == statusApproved) {
      return {'label': 'Disetujui', 'color': 0xFF6366F1, 'bgColor': 0xFFEEF2FF};
    }
    if (s == statusMenungguBiaya) {
      return {
        'label': 'Menunggu Biaya',
        'color': 0xFFF59E0B,
        'bgColor': 0xFFFEF3C7,
      };
    }
    if (s == statusKeKetuaTim) {
      return {
        'label': 'Ke Ketua Tim',
        'color': 0xFF7C3AED,
        'bgColor': 0xFFF5F3FF,
